...
public class DetermineBasalAdapterAMAJS {
    ...
    public DetermineBasalResultAMA invoke() {
        ...
        try {
            ...
            rhino.evaluateString(scope, readFile("Pid/loggerhelper.js"), "JavaScript", 0, null);
            ...
            rhino.evaluateString(scope, readFile("Pid/determine-basal.js"), "JavaScript", 0, null);
            rhino.evaluateString(scope, readFile("Pid/basal-set-temp.js"), "setTempBasal.js", 0, null);
