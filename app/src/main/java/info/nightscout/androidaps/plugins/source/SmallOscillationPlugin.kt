...
object SmallOscillationPlugin : PluginBase(PluginDescription()
        .mainType(PluginType.BGSOURCE)
        .fragmentClass(BGSourceFragment::class.java.name)
        .pluginName(R.string.smalloscillation)
        .shortName(R.string.smalloscillation_short)
        .description(R.string.description_source_smalloscillation)), BgSourceInterface {
    ...
    override fun handleNewData(intent: Intent) {
        ...
        MainApp.getDbHelper().createIfNotExists(bgReading, "Oscillation")
